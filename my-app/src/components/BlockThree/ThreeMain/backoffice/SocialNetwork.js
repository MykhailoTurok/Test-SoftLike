    ...
    render() {
        return (
            <div className="threeMain-content-conteiner">
                <div className="threeMain-content-topText">
                    ...
                    <ul>
                        <li><img src={markImg} alt="" /> RSS feed</li>
                        <li><img src={markImg} alt="" /> Polls</li>
                        <li><img src={markImg} alt="" /> Blog</li>
                        <li><img src={markImg} alt="" /> Knowledge data base</li>
                        <li><img src={markImg} alt="" /> Event calendar</li>
                    </ul>
                </div>
                <p className="threeMain-content-bottomText">The company’s performance depends on who promotes its product and the way how it is done. If you have a lot of employees, it is difficult to attain a uniform level of knowledge without gaps and misrepresentations, to communicate with each individual, to provide timely information, to make the personnel take important issues into account. Oftentimes people come out with lots of ideas, and it creates chaos at the workplace.</p>
